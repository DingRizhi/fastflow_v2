...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--labelme_images",
        default="/home/log/PycharmProjects/new-YOLOv1_PyTorch/data/scripts/COCO/person_coco/val2017",
        help="Directory to labelme images and annotation json files.",
        type=str,
    )
    parser.add_argument(
        "--output", help="Output json file path.",
        default="/home/log/PycharmProjects/new-YOLOv1_PyTorch/data/scripts/COCO/person_coco/annotations2/instances_val2017.json"
    )
